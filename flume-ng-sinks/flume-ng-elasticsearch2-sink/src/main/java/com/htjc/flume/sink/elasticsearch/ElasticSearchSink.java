...
import com.htjc.flume.sink.elasticsearch.client.ElasticSearchClient;
import com.htjc.flume.sink.elasticsearch.client.ElasticSearchClientFactory;
...
public class ElasticSearchSink extends AbstractSink implements Configurable {
    ...
    public void configure(Context context) {
        ...
        logger.info(indexNameBuilderClass);
        ...
        logger.info("2:" + indexNameBuilderClass);
